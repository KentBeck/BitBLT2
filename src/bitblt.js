 ...
 * @param {string} op - Operation to perform: 'copy', 'and', 'or', 'xor'
 */
function bitblt(dst, dstX, dstY, width, height, src, srcX, srcY, op = 'copy') {
 ...
 * @param {string} op - Operation to perform: 'copy', 'and', 'or', 'xor'
 */
function bitbltAligned(dst, dstX, dstY, width, height, src, srcX, srcY, op = 'copy') {
