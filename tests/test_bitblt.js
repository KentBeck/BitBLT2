...
console.log(`Created bitmap: ${bitmap1.width}x${bitmap1.height}, ${bitmap1.intsPerRow} integers per row`);
...
bitblt(dst, 16, 4, 32, 8, src, 16, 4, 'copy');
...
bitblt(dst, 16, 4, 32, 8, src, 16, 4, 'or');
...
// Test aligned copy
bitbltAligned(dstAligned, 0, 4, 32, 8, srcAligned, 32, 4, 'copy');
...
bitblt(largeDst, 0, 0, 1024, 1024, largeSrc, 0, 0, 'copy');
...
bitbltAligned(largeDst, 0, 0, 1024, 1024, largeSrc, 0, 0, 'copy');
